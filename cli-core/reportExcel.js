            ...
            obj.pages.forEach(page => {
                ...
                if (page.actions) {
                    ...
                    sheet_data = [
                        ...
                        ["Taille de la page (Ko)", `${Math.round(page.actions[page.actions.length - 1].responsesSize / 1000)} (${Math.round(page.actions[page.actions.length - 1].responsesSizeUncompress / 1000)})`],
